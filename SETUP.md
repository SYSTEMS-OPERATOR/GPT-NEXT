...
*conf* directory. You can create the conda environment with:
...
*conf* directory. All model parameters are the same as mentioned in [Improving
...
`generate.yml` file in the *conf* folder.
